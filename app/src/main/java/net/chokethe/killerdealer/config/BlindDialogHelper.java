...
public class BlindDialogHelper {
    ...
    public static void showUpdate(final Context context, final BlindsAdapter.BlindViewHolder blindViewHolder) {
...
//            mBlind.addTextChangedListener(blindEditTextListener);
                        ...
                        KillerDealerDbHelper db = new KillerDealerDbHelper(context);
